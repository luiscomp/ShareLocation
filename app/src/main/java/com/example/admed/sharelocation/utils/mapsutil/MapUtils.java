package com.example.admed.sharelocation.utils.mapsutil;
...
/**
 * Created by LuisEduardo on 08/07/2016.
 */
public class MapUtils {
    ...
    public static void startDropMarkerAnimation(final Marker marker, GoogleMap mapa) {
    ...
    public void desenharRotaNoMapa(Context context, GoogleMap mMap, LatLng origem, LatLng destino) {
        this.mMap = mMap;
    ...
    private static String getDirectionsUrl(LatLng origem,LatLng destino){

        // Origin of route
        String str_origin = "origin="+origem.latitude+","+origem.longitude;
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    lineOptions.color(context.getColor(R.color.colorPrimaryDark));
                } else {
